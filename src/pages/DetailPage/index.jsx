...
import DamegeRelations from "../../components/DamegeRelations";
...
async function fetchPokemonData(id){
    ...
    try {
         ...
         if(pokemonData){
          ...
          const nextAndPreviousPokemon = await nextAndPreviousPokemon(id);
          //console.log(stats)
...
async function nextAndPreviousPokemon(id){
...
console.log(pokemon,bg,text)
  ...
  return (
    ...
    <section className="w-full flex flex-col -20 items-center justify-end relative h-full">
   ...
   <section className="w-full min-h-[65%] h-full bg-gray-800 z-10 pt-14 flex flex-col items-center gap-3 px-5 pb-4">
    ...
    <div className="flex items-center justify-center gap-4">
      ...
      <div className="w-full">
          <h4 className="text-[0.5rem] text-zinc-100">Heiht</h4>
          <div className="text-sm flex mt-1 gap-2 justify-center text-zinc-200">
          <Vector />
          {pokemon.height}m
        </div>
