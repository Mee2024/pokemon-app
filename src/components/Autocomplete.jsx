...
const Autocomplete = (allpokemons,setdisplayedPokemons) => {
    ...
    const filterNames = (input) => {
        ...
        return value ? allpokemons.filter((e).name.includes(value)): [];
    }
  ...
  return (
    <div className='relative z-50'>
            ...
            {checkEqulName(SearchTerm).length > 0 && (
                <div
                className={
                    `w-full flex fbottom-0 h-0 flex-col absolute justify-center items-center translate-y-2`
                }
                >
                    <div className={
                    ...
                    >
                        {checkEqulName(SearchTerm).map((e,i) =>(
                            <li key={`button-${i}`}>
                                <button
